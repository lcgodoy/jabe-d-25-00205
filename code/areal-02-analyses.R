...
source("code/utils/approx_hausdorff.R")
...
bym2 <- stan_model(
    file = "stan_models/areal/bym2.stan",
    allow_optimizations = TRUE
)

dagar <- stan_model(
    file = "stan_models/areal/dagar.stan",
    allow_optimizations = TRUE
)
...
mcmc_trace(x = fit_hgp,
  ...
  legend_none()  
ggsave(filename = "img/scot-trace-hgp.pdf",
       width = 6,
       height = 5)
...
mcmc_dens_overlay(x = fit_hgp,
                  ...
                  facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-dens-hgp.pdf",
       width = 6,
       height = 5)
...
mcmc_trace(x = fit_hgp,
           ...
           facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-trace-ref-hgp.pdf",
       width = 6,
       height = 5)
...
mcmc_dens_overlay(x = fit_hgp,
                  ...
                  facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-dens-ref-hgp.pdf",
       width = 6,
       height = 5)
...
pairs(fit_bym2, pars = c("beta_0", "beta", "sigma",
                         "xi"))
...
mcmc_trace(x = fit_bym2,
           ...
           facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-trace-bym.pdf",
       width = 6,
       height = 5)
...
mcmc_dens_overlay(x = fit_bym2,
                  ...
                  facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-dens-bym.pdf",
       width = 6,
       height = 5)
...
mcmc_trace(x = fit_bym2,
           ...
           facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-trace-ref-bym.pdf",
       width = 6,
       height = 5)
...
mcmc_dens_overlay(x = fit_bym2,
                  ...
                  facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-dens-ref-bym.pdf",
       width = 6,
       height = 5)
...
mcmc_trace(x = fit_dagar,
           ...
           facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-trace-dagar.pdf",
       width = 6,
       height = 5)
...
mcmc_dens_overlay(x = fit_dagar,
                  ...
                  facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-dens-dagar.pdf",
       width = 6,
       height = 5)
...
mcmc_trace(x = fit_dagar,
           ...
           facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-trace-ref-dagar.pdf",
       width = 6,
       height = 5)
...
mcmc_dens_overlay(x = fit_dagar,
                  ...
                  facet_args = list(labeller = label_parsed)) +
  legend_none()
ggsave(filename = "img/scot-dens-ref-dagar.pdf",
       width = 6,
       height = 5)
...
ggsave(filename = "img/scotland_rho_post.pdf",
       width = .7 * 6.7,
       height = .7 * 6.7 / 1.618033)
ggsave(filename = "~/phd/thesis/img/scotland_rho_post.pdf",
       width = 4.5,
       height = 4.5 / 1.618033)
ggsave(filename = "img/scotland_rho_post.png",
       width = 6.7,
       height = 6.7 / 1.618033)
...
ggsave(filename = "img/scotland_corr_func.pdf",
       width = 6,
       height = 6 / 1.618033)
ggsave(filename = "img/scotland_corr_func.png",
       width = 6,
       height = 6 / 1.618033)
...
saveRDS(my_dt2, file = "~/phd/thesis/talk/scotsir.rds")
...
ggsave(filename = "img/scot-smr.pdf",
       width = 6,
       height = 6)
ggsave(filename = "~/phd/thesis/img/scot-smr.pdf",
       width = 6,
       height = 6)
ggsave(filename = "img/scot-smr.png",
       width = 6,
       height = 6)
